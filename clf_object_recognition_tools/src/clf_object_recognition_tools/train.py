...
class TrainPlugin(Plugin):
    ...
    def __init__(self, context):
        ...
        self._train_button.clicked.connect(self._retrain_inception)
    ...
    def _train_detector(self):
        ...
        try:
            ...
            dialog("Training failed", "Something went wrong during training, '%s'" % str(e), QMessageBox.Warning)

    def _retrain_inception(self):
        """
